    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(MainActivity.this, contactList,
                    ...
                    //list item is the list xml, we use activity list
                    R.layout.activity_list, new String[]{ "id", "latitude","longitude","city","region","timestamp"},
                    new int[]{R.id.id, R.id.latitude, R.id.longitude,R.id.city, R.id.region, R.id.timestamp});
